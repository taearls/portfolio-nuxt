    ...
    data() {
        return {
            ...
            },
            {
                "name": "Road Ranger",
                "index": 2,
                "description": "A header with navigation that I built while freelancing for <a href='https://trekk.com' rel='noreferrer' target='_blank'>Trekk</a>. Both the mobile and desktop versions are based on their designs.",
