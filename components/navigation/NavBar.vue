      ...
      <ul class="flex flex-col h-auto justify-center sm:flex-row sm:justify-end">
        ...
        >
          <a
            ...
            :tabindex="isNavActive ? 0 : -1"
            target="_blank"
            class="sm:flex sm:items-center sm:justify-center px-4 text-lg font-extrabold text-purple-700 dark:text-purple-500 dark-hover:text-blue-300 focus:outline-none focus:shadow-outline rounded-sm"
          >
            {{ externalLink.name }}
            <svg
              class="absolute inline-block ml-1 sm:static sm:mx-1 sm:mb-1"
              height="24px"
              width="24px"
              :fill="prefersDarkMode ? '#9f7aea' : '#6b46c1'"
